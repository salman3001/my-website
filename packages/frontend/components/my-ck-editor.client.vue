...
<template>
  <div class="bg-background ck-reset" style="color: inherit">
    <ckeditor
      v-model="model"
      :editor="editor"
      :config="editorConfig"
...
:root {
  ...
  --ck-color-base-active: var(--v-theme-primary-lighten);
  --ck-color-base-active-focus: var(--v-theme-primary);
  ...
  --ck-color-button-on-color: var(--v-theme-primary);
  ...
  --ck-color-link-default: var(--v-theme-primary);
...
.ck.ck-button.ck-switchbutton .ck-button__toggle {
  border-radius: 0;
  transition: background 400ms ease, box-shadow 0.2s ease-in-out,
...
[dir="rtl"]
  ...
  > .ck.ck-label {
  transform: translate(
      calc(-1 * var(--ck-labeled-field-label-default-position-x)),
      var(--ck-labeled-field-label-default-position-y)
    )
    scale(1);
}
...
@media screen and (max-width: 600px) {
  ...
  [dir="rtl"]
    .ck.ck-responsive-form
    > .ck-button:nth-last-child(1):last-of-type,
  [dir="rtl"]
    .ck.ck-responsive-form
...
.ck.ck-editor__editable .ck.ck-clipboard-drop-target-position span::after {
  ...
  border-width: calc(var(--ck-clipboard-drop-target-dot-height))
    calc(0.5 * var(--ck-clipboard-drop-target-dot-width)) 0
    calc(0.5 * var(--ck-clipboard-drop-target-dot-width));
  border-style: solid;
}
...
[dir="ltr"] .ck.ck-clipboard-drop-target-line::before {
  ...
  border-width: calc(0.5 * var(--ck-clipboard-drop-target-dot-width)) 0
    calc(0.5 * var(--ck-clipboard-drop-target-dot-width))
...
[dir="rtl"] .ck.ck-clipboard-drop-target-line::before {
  ...
  border-width: calc(0.5 * var(--ck-clipboard-drop-target-dot-width))
    var(--ck-clipboard-drop-target-dot-height)
    calc(0.5 * var(--ck-clipboard-drop-target-dot-width)) 0;
...
.ck .ck-image-upload-placeholder.image-inline {
  width: calc(
    2 * var(--ck-upload-placeholder-loader-size) *
...
:root {
  ...
  --ck-color-restricted-editing-exception-hover-background: hsla(
    31,
    100%,
    65%,
    0.35
  ...
  --ck-color-restricted-editing-selected-exception-background: hsla(
    31,
    100%,
    65%,
    0.5
  );
  --ck-color-restricted-editing-selected-exception-brackets: hsla(
    31,
    100%,
    40%,
    0.6
...
.ck .ck-widget .ck-widget__type-around__fake-caret {
  pointer-events: none;
  height: 1px;
  animation: ck-widget-type-around-fake-caret-pulse linear 1s infinite normal
    forwards;
  outline: solid 1px hsla(0, 0%, 100%, 0.5);
