...
export async function seedUser(prisma: PrismaClient) {
  await prisma.user.upsert({
    where: { email: "sakman.k3001@gmail.com" },
    update: {},
    create: {
      fullName: "Salman Khan",
      email: "sakman.k3001@gmail.com",
      userName: "Salman",
...
export async function seedDiscussions(prisma: PrismaClient) {
  await prisma.discussion.upsert({
    where: { id: "i-wan-to-have-a-baby-tell-me-the-instructions" },
    update: {},
    create: {
      id: "i-wan-to-have-a-baby-tell-me-the-instructions",
      title: "I wan to have a baby, Tell me the instructions",
